...
<div id="field-birth_day" class="control-inline-group"><label class="form_label required" for="birth_day">Data de criação do CNPJ</label>
...
<div id="field-shows" class="radio-block"><label class="radio-label required" for="shows">Escolha aqui a data do show que quer ir: *</label>
